...
namespace CarControl.Controllers
{
    public class VeiculoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,id_Motorista,Placa,Modelo,Marca,VeiculoSegurado")] Veiculo veiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,id_Motorista,Placa,Modelo,Marca,VeiculoSegurado")] Veiculo veiculo)
        {
            if (ModelState.IsValid)
            {
